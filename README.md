...
Open-source **Django Dashboard** generated by `AppSeed` op top of an iconic `Bootstrap 5` Design. For newcomers, **[Star Admin](https://appseed.us/product/star-admin/django/)** is a beautifully designed admin template featuring a fine selection of useful Bootstrap components and elements. The pre-built pages of the templates are intuitive and very well-designed.
...
---
[Star Admin Django](https://appseed.us/product/star-admin/django/) - Open-source starter generated by **[App Generator](https://appseed.us/generator/)**.
